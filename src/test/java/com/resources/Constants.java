...
//PATHs
	...
	public static String text = System.getProperty("user.dir")+"//src//test//java//com//config//text.properties";
...
// 
	...
	public static final String base_url = "https://qa-ew-demo.ewhosts.net";
	public static final String username = "interview@ewhosts.net";
	public static final String password = "SweetTestingProblem";
	public static final String email_field = "//input[@id='user_email']";
	public static final String password_field = "//input[@id='user_password']";
	public static final String sign_in_button = "//button[text()='Sign in']";

	
	public static final String number_of_answers = "//i[@class='Icon icon icon-comments-o']/following::span";
	public static final String number_of_views = "//i[@class='Icon icon icon-eye']/following::span";
	public static final String second_dropdown_arrow = " (//i[@class='Icon icon icon-angle-down toggle-icon'])[last()]";
	public static final String popular_questions_link = "//a[text()='Popular questions']";
...
//	public static final String global_save_step_button = "//button[@ng-click='SaveJobFilingAC()']";
	...
	//div[@class='col-xs-12 col-sm-12 col-md-12 veil-portal-AN ng-scope
